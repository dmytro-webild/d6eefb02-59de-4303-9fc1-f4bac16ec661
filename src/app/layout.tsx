...
export const metadata: Metadata = {
  title: "Web Design Specialist | Professional Websites for Business Growth",  description: "Jo creates modern, organized, and attractive websites nationwide. Launched in 2024. Professional web design that converts visitors into clients. Get in touch today.",  keywords: "web design, website design, professional websites, web designer, responsive design, business websites, web design specialist",  metadataBase: new URL("https://jowebdesign.com"),
  alternates: {
    canonical: "https://jowebdesign.com"},
  openGraph: {
    title: "Jo - Web Design Specialist | Modern Professional Websites",    description: "Craft organized, attractive, modern websites that drive business growth. Jo specializes in professional web design nationwide.",    url: "https://jowebdesign.com",    siteName: "Jo Web Design",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-psd/fashion-sale-landing-page-template_23-2149528740.jpg",        alt: "Jo's professional website design portfolio"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Jo - Professional Web Design Specialist",    description: "Modern websites that convert. Nationwide service. Let's build your online presence.",    images: ["http://img.b2bpic.net/free-psd/fashion-sale-landing-page-template_23-2149528740.jpg"],
  },
  robots: {
    index: true,
    follow: true,
